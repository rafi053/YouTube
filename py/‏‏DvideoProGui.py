...
class YouTubeDownloaderApp:
    def __init__(self, root):
        ...
        # Video/audio choice
        self.choice_label = tk.Label(root, text="Choose download type:")
        self.choice_label.pack(pady=5)
        self.choice_var = tk.StringVar()
        self.choice_var.set("1")  # default is video

        self.video_radio = tk.Radiobutton(root, text="Video", variable=self.choice_var, value="1")
        self.video_radio.pack(pady=2)
        self.audio_radio = tk.Radiobutton(root, text="Audio", variable=self.choice_var, value="2")
        self.audio_radio.pack(pady=2)

        # Subtitles choice
        self.subtitles_label = tk.Label(root, text="Choose subtitles language (only for video):")
        self.subtitles_label.pack(pady=5)
        self.subtitles_var = tk.StringVar()
        self.subtitles_var.set("2")  # default is no subtitles

        self.subtitles_english = tk.Radiobutton(root, text="English", variable=self.subtitles_var, value="1")
        self.subtitles_english.pack(pady=2)
        self.subtitles_hebrew = tk.Radiobutton(root, text="Hebrew", variable=self.subtitles_var, value="2")
